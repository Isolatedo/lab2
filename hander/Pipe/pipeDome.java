package lab2.hander.Pipe;

import java.io.*;
import java.util.*;

public class pipeDome {
    public void do4() {
        File inFile = new File("D:\\IdeaProjects\\javaModel\\src\\lab2\\input.txt");
        File outFile = new File("D:\\IdeaProjects\\javaModel\\src\\lab2\\output\\output4");
        Pipe pipe1 = new Pipe();
        Pipe pipe2 = new Pipe();
        Pipe pipe3 = new Pipe();
